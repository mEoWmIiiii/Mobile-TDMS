...
const emptyForm = (): FormState => ({
  ...
  air: {
    ...
    step3: { goodPhysicalCondition: false, labelsMarking: false, remarks: "ok", remarksChecked: false, weather: "", date: "", time: "", quantity: "", warehouseRep: "" },
    step4: { mawb: "", goodPhysicalCondition: false, labelsMarking: false, remarks: "ok", remarksChecked: false, weather: "", date: "", time: "", quantity: "", airlineRep: "" },
  },
});
...
export function NewBookingForm({ visible, isEditMode = false, initialData, onSubmit, onCancel }: { visible: boolean; isEditMode?: boolean; initialData?: Partial<FormState>; onSubmit: (data: FormState) => void; onCancel: () => void; }) {
  ...
  const operationalPhase = useMemo(() => {
    if (form.air.step4.airlineRep) return 4;
    if (form.air.step3.warehouseRep) return 3;
